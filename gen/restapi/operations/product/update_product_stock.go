...
type UpdateProductStockHandlerFunc func(UpdateProductStockParams, *models.Principal) middleware.Responder

// Handle executing the request and returning a response
func (fn UpdateProductStockHandlerFunc) Handle(params UpdateProductStockParams, principal *models.Principal) middleware.Responder {
...
type UpdateProductStockHandler interface {
	Handle(UpdateProductStockParams, *models.Principal) middleware.Responder
}
